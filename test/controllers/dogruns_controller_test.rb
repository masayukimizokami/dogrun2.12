...
class DogrunsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dogrun" do
    assert_difference('Dogrun.count') do
      post dogruns_url, params: { dogrun: { a: @dogrun.a, dogrun_name: @dogrun.dogrun_name } }
    end
  ...
  test "should update dogrun" do
    patch dogrun_url(@dogrun), params: { dogrun: { a: @dogrun.a, dogrun_name: @dogrun.dogrun_name } }
